...
import com.xiesx.springboot.support.jdbc.persistence.annotation.Comment;
import com.xiesx.springboot.support.jdbc.persistence.annotation.Default;
import com.xiesx.springboot.support.jdbc.persistence.annotation.Entity;
import com.xiesx.springboot.support.jdbc.persistence.annotation.Id;
import com.xiesx.springboot.support.jdbc.persistence.annotation.Index;
import com.xiesx.springboot.support.jdbc.persistence.annotation.Indexes;
import com.xiesx.springboot.support.jdbc.persistence.annotation.PK;
import com.xiesx.springboot.support.jdbc.persistence.annotation.Property;
import com.xiesx.springboot.support.jdbc.persistence.annotation.Readonly;
import com.xiesx.springboot.support.jdbc.persistence.annotation.ShardingRule;
...
public final class EntityMeta {
		...
		if (_returnMeta == null) {
			...
			if (ClassUtils.isAnnotationOf(targetClass, Entity.class)) {
				_returnMeta = new EntityMeta(
						...
						ClassUtils.isAnnotationOf(targetClass, Readonly.class),
	...
	private static PropertyMeta __doGetPropertyMeta(Property property, Field field, EntityMeta targetMeta) {
		...
		if (!targetMeta.containsProperty(_propName)) {
			...
			_meta = new PropertyMeta(_propName, field, property.autoincrement(), property.sequenceName(),
					property.nullable(), property.unsigned(), property.length(), property.decimals(), property.type());
	...
	public String toString() {
		return "EntityMeta{" + "entityName='" + __entityName + '\'' + ", primaryKeyClass=" + __primaryKeyClass
				+ ", primaryKeys=" + __primaryKeys + ", autoincrementProps=" + __autoincrementProps + ", readonlyProps="
				+ __readonlyProps + ", properties=" + __properties + ", fields=" + __fields + ", indexes=" + __indexes
				+ ", multiplePrimaryKey=" + __multiplePrimaryKey + ", comment='" + __comment + '\'' + '}';
	}
	...
	public static class PropertyMeta {
		...
		@Override
		public String toString() {
			return "PropertyMeta{" + "name='" + name + '\'' + ", field=" + field + ", autoincrement=" + autoincrement
					+ ", sequenceName='" + sequenceName + '\'' + ", nullable=" + nullable + ", unsigned=" + unsigned
					+ ", length=" + length + ", decimals=" + decimals + ", type=" + type + ", defaultValue='"
					+ defaultValue + '\'' + ", comment='" + comment + '\'' + ", readonly=" + readonly + '}';
		}
	}
