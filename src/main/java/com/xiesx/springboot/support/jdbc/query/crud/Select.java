 ...
 */
package com.xiesx.springboot.support.jdbc.query.crud;
...
import com.xiesx.springboot.support.jdbc.query.IDBLocker;
...
public final class Select extends Query<Select> {
	...
	public String toString() {
		...
		//
		if (__page != null) {
			_selectSB = new StringBuilder(
					this.dialect().buildPagedQuerySQL(_selectSB.toString(), __page.page(), __page.pageSize()))
							.append(" ");
		}
		//
