...
public class BaseResult {
	...
	public static BaseResult success(@NonNull String msg) {
		return BaseResult.builder().code(SUCCESS).msg(msg).build();
	}

	public static BaseResult success(@NonNull Object data) {
		return BaseResult.builder().code(SUCCESS).msg(OP_MSG_SUCC).data(data).build();
	}
	...
	public static BaseResult success(@NonNull Integer code, @NonNull String msg, @NonNull Object data) {
	...
	*//**
	...
	public static BaseResult fail(@NonNull String msg) {
		return BaseResult.builder().code(FAIL).msg(msg).build();
	}

	public static BaseResult fail(@NonNull Object data) {
		return BaseResult.builder().code(FAIL).msg(OP_MSG_FAIL).data(data).build();
	}

	public static BaseResult fail(@NonNull String msg, Object data) {
		return BaseResult.builder().code(FAIL).msg(msg).data(data).build();
	}
	...
	*//**
	...
	public static BaseResult error(@NonNull String msg) {
		return BaseResult.builder().code(ERROR).msg(msg).build();
	}

	public static BaseResult error(@NonNull Object data) {
		return BaseResult.builder().code(ERROR).msg(OP_MSG_FAIL).data(data).build();
	}

	public static BaseResult error(@NonNull String msg, Object data) {
		return BaseResult.builder().code(ERROR).msg(msg).data(data).build();
	}
