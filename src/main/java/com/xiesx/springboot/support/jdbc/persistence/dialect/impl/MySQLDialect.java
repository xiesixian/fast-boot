 ...
 */
package com.xiesx.springboot.support.jdbc.persistence.dialect.impl;
...
import com.xiesx.springboot.support.jdbc.persistence.base.Type;
import com.xiesx.springboot.support.jdbc.persistence.dialect.AbstractDialect;
			...
			for (EntityMeta.PropertyMeta _propMeta : _propMetas) {
				...
				if (_propMeta.isUnsigned()) {
					if ("NUMERIC".equals(_propType) || "LONG".equals(_propType) || "FLOAT".equals(_propType)
							|| "SMALLINT".equals(_propType) || "TINYINT".equals(_propType) || "DOUBLE".equals(_propType)
