...
public interface Attempt<V> {
     ...
     * @throws ExecutionException if an exception was thrown by the attempt. The thrown exception is set
     ...
     * @throws IllegalStateException if the call didn't return a result, but threw an exception, as
     *         indicated by {@link #hasResult()}
     */
     ...
     * @throws IllegalStateException if the call didn't throw an exception, as indicated by
     *         {@link #hasException()}
     */
